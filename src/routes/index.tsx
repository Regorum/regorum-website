  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground transition-colors duration-500">
      ...
      <section className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6">
        <h1
          className="animate-float-up text-center font-display font-bold tracking-wide text-foreground md:text-7xl lg:text-8xl overflow-visible my-0 rounded-none text-9xl px-[15px] py-[20px]"
          style={{ textShadow: isDark ? '0 2px 20px rgba(0,0,0,0.5)' : '0 2px 20px rgba(255,255,255,0.8)' }}
        >
          Regorum
          <span className="block bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent drop-shadow-none py-[20px]" style={{ textShadow: 'none' }}>
            Technologies
          </span>
        </h1>
